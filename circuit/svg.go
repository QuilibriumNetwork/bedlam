...
func (c *Circuit) Svg(out io.Writer) {
  ...
  <style><![CDATA[
  text {
    font: 10pt ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, "Liberation Mono", "Courier New", monospace;
  }
  ]]></style>
...
func path(out io.Writer) {
	fmt.Fprintln(out, `  <path fill="none" stroke="#fff" stroke-width=".5"`)
}
